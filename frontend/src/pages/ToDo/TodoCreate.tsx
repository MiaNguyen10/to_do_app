...
const TodoCreate = () => {
  ...
  const createTaskMutation = useMutation({
    ...
    onSuccess: () => {
      toast("You have successfully created the task!");
      form.reset({
        title: "",
        status_id: "1",
        priority_id: "1",
        description: "",
        due_date: null, // Reset to null
      });
    },
    onError: (error) => {
  ...
  const onSubmit = (data: z.infer<typeof formSchema>) => {
    ...
    createTaskMutation.mutate({
        ...
        due_date: data.due_date ? data.due_date.toISOString().split('T')[0] : undefined, // Convert Date to YYYY-MM-DD string or undefined
    })
  };
      ...
      <div className="flex items-center justify-between space-y-2">
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            Here&apos;s a form to create your new task!
          </p>
        </div>
